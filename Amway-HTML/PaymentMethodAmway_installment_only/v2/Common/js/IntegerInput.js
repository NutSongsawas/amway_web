...
(() => {
  function initIntegerInput() {
    ...
    const isRemovable = integerInput.data('removable-on-min');
    const removeButton = integerInput.find('[data-remove]');
    ...
    function updateMin(value) {
      ...
      if (value <= min) {
        if (isRemovable) {
          ...
          decrementButton.addClass('--hidden');
        } else {
          decrementButton.attr('disabled', true);
        }
      } else if (value > min) {
        removeButton.addClass('--hidden');
        decrementButton.removeClass('--hidden');
